...
// Public/private: requiere usuario autenticado
...
// Precios en centavos USD (puedes ajustar a PEN si usas multi-currency en Stripe)
...
serve(async (req) => {
  ...
  try {
    ...
    // Buscar customer existente o crear
