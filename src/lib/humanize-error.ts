...
const TECHNICAL_PATTERNS: Array<{ match: RegExp; friendly: string }> = [
  // Edge functions
  { match: /edge function.*non-?2xx/i,         friendly: "El servicio no respondió. Vuelve a intentarlo en unos segundos." },
  { match: /FunctionsHttpError/i,              friendly: "El servicio no respondió. Vuelve a intentarlo en unos segundos." },
  { match: /FunctionsRelayError/i,             friendly: "Hubo un problema de conexión con el servicio." },
  { match: /FunctionsFetchError/i,             friendly: "No pudimos contactar al servicio. Revisa tu conexión." },
  { match: /Failed to (fetch|send)/i,          friendly: "No pudimos contactar al servicio. Revisa tu conexión." },
